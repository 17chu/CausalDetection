...
causalOutput = open("causalOutput.txt","w",buffering=1)
#AllOutput = open("completeOutput.txt","w",buffering=1)
#tag_patterns = r"""
  #NP: {<DT|.*P\$|CD>?<JJ>*<NN.*>+}   # chunk determiner/possessive, adjectives and noun
      #{<PRP>}                 # Personal Pronouns
  #PP: {<IN><NP>}              # Prepositional Phrase
  #VP: {<VB.*><NP|PP|CLAUSE>+$} # Chunk Verbs and their arguments (Verb phrase)
  #CLAUSE: {<NP><VP>}          # Chunk NP,VP
  
  #CP: {<NP><VB.*><NP>}        # Potentially Causal Phrase
